...
You can also make an ap command to connect your drone to your wifi with: name ap and ASCII ap ROUTER_SSID ROUTER_PASSWORD . This makes it easy to create a drone swarm
